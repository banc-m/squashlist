 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on=new df("@firebase/app"),Rg="@firebase/app-compat",Mg="@firebase/analytics-compat",Dg="@firebase/analytics",Lg="@firebase/app-check-compat",Fg="@firebase/app-check",Hg="@firebase/auth",Bg="@firebase/auth-compat",zg="@firebase/database",Ug="@firebase/database-compat",$g="@firebase/functions",Wg="@firebase/functions-compat",jg="@firebase/installations",Vg="@firebase/installations-compat",Yg="@firebase/messaging",qg="@firebase/messaging-compat",Kg="@firebase/performance",Gg="@firebase/performance-compat",Qg="@firebase/remote-config",Xg="@firebase/remote-config-compat",Jg="@firebase/storage",Zg="@firebase/storage-compat",e_="@firebase/firestore",t_="@firebase/firestore-compat",n_="firebase",i_="9.23.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[vn,Ke]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const n=Ke&&Ke.isAvailable();let i=n&&!Ke.previouslyFailed();if(e.webSocketOnly&&(n||De("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[Ke];else{const r=this.transports_=[];for(const s of Ei.ALL_TRANSPORTS)s&&s.isAvailable()&&r.push(s);Ei.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Ei.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ir;class qf extends hs{static get __EMPTY_NODE(){return ir}static set __EMPTY_NODE(e){ir=e}compare(e,n){return Vn(e.name,n.name)}isDefinedOn(e){throw Wn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return $.MIN}maxPost(){return new $(an,ir)}makePost(e,n){return E(typeof e=="string","KeyIndex indexValue must always be a string."),new $(e,ir)}toString(){return".key"}}const kn=new qf;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xo;function bv(t){xo=t}const Kf=function(t){return typeof t=="number"?"number:"+Ef(t):"string:"+t},Gf=function(t){if(t.isLeafNode()){const e=t.val();E(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ct(e,".sv"),"Priority must be a string or number.")}else E(t===xo||t.isEmpty(),"priority of unexpected type.");E(t===xo||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fr{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=Je.ACK_USER_WRITE,this.source=eh()}operationForChild(e){if(W(this.path)){if(this.affectedTree.value!=null)return E(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new X(e));return new Fr(q(),n,this.revert)}}else return E(V(this.path)===e,"operationForChild called for unrelated child."),new Fr(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ti{constructor(e,n){this.source=e,this.path=n,this.type=Je.LISTEN_COMPLETE}operationForChild(e){return W(this.path)?new Ti(this.source,q()):new Ti(this.source,te(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ai{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=Je.MERGE}operationForChild(e){if(W(this.path)){const n=this.children.subtree(new X(e));return n.isEmpty()?null:n.value?new ln(this.source,q(),n.value):new Ai(this.source,q(),n)}else return E(V(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ai(this.source,te(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t1="repo_interrupt",n1=25;class i1{constructor(e,n,i,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Jy,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Lr(),this.transactionQueueTree_=new za,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function r1(t,e,n){if(t.stats_=wa(t.repoInfo_),t.forceRestClient_||L_())t.server_=new Dr(t.repoInfo_,(i,r,s,o)=>{Oc(t,i,r,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Rc(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{de(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new gt(t.repoInfo_,e,(i,r,s,o)=>{Oc(t,i,r,s,o)},i=>{Rc(t,i)},i=>{o1(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=U_(t.repoInfo_,()=>new Bv(t.stats_,t.server_)),t.infoData_=new Mv,t.infoSyncTree_=new Nc({startListening:(i,r,s,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=Ui(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),ja(t,"connected",!1),t.serverSyncTree_=new Nc({startListening:(i,r,s,o)=>(t.server_.listen(i,s,r,(a,l)=>{const c=o(a,l);ut(t.eventQueue_,i._path,c)}),[]),stopListening:(i,r)=>{t.server_.unlisten(i,r)}})}function s1(t){const n=t.infoData_.getNode(new X(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Wa(t){return Hy({timestamp:s1(t)})}function Oc(t,e,n,i,r){t.dataUpdateCount++;const s=new X(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(i){const l=kr(n,c=>ye(c));o=Py(t.serverSyncTree_,s,l,r)}else{const l=ye(n);o=_h(t.serverSyncTree_,s,l,r)}else if(i){const l=kr(n,c=>ye(c));o=Ay(t.serverSyncTree_,s,l)}else{const l=ye(n);o=Ui(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=ys(t,s)),ut(t.eventQueue_,a,o)}function Rc(t,e){ja(t,"connected",e),e===!1&&c1(t)}function o1(t,e){Fe(e,(n,i)=>{ja(t,n,i)})}function ja(t,e,n){const i=new X("/.info/"+e),r=ye(n);t.infoData_.updateSnapshot(i,r);const s=Ui(t.infoSyncTree_,i,r);ut(t.eventQueue_,i,s)}function kh(t){return t.nextWriteId_++}function a1(t,e,n){const i=Ry(t.serverSyncTree_,e);return i!=null?Promise.resolve(i):t.server_.get(e).then(r=>{const s=ye(r).withIndex(e._queryParams.getIndex());Oy(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=Ui(t.serverSyncTree_,e._path,s);else{const a=ki(t.serverSyncTree_,e);o=_h(t.serverSyncTree_,e._path,s,a)}return ut(t.eventQueue_,e._path,o),gh(t.serverSyncTree_,e,n,null,!0),s},r=>(vs(t,"get for query "+de(e)+" failed: "+r),Promise.reject(new Error(r))))}function l1(t,e,n,i,r){vs(t,"set",{path:e.toString(),value:n,priority:i});const s=Wa(t),o=ye(n,i),a=Ra(t.serverSyncTree_,e),l=wh(o,a,s),c=kh(t),u=mh(t.serverSyncTree_,e,l,c,!0);Ah(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,m)=>{const y=h==="ok";y||De("set at "+e+" failed: "+h);const w=Xt(t.serverSyncTree_,c,!y);ut(t.eventQueue_,e,w),f1(t,r,h,m)});const f=Mh(t,e);ys(t,f),ut(t.eventQueue_,f,[])}function c1(t){vs(t,"onDisconnectEvents");const e=Wa(t),n=Lr();Io(t.onDisconnect_,q(),(r,s)=>{const o=Uy(r,s,t.serverSyncTree_,e);Zf(n,r,o)});let i=[];Io(n,q(),(r,s)=>{i=i.concat(Ui(t.serverSyncTree_,r,s));const o=Mh(t,r);ys(t,o)}),t.onDisconnect_=Lr(),ut(t.eventQueue_,q(),i)}function u1(t){t.persistentConnection_&&t.persistentConnection_.interrupt(t1)}function vs(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),xe(n,...e)}function f1(t,e,n,i){e&&Yn(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let s=r;i&&(s+=": "+i);const o=new Error(s);o.code=r,e(o)}})}function Nh(t,e,n){return Ra(t.serverSyncTree_,e,n)||L.EMPTY_NODE}function Va(t,e=t.transactionQueueTree_){if(e||bs(t,e),qn(e)){const n=Oh(t,e);E(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&h1(t,Wi(e),n)}else Eh(e)&&_s(e,n=>{Va(t,n)})}function h1(t,e,n){const i=n.map(c=>c.currentWriteId),r=Nh(t,e,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const u=n[c];E(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const f=Pe(e,u.path);s=s.updateChild(f,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,c=>{vs(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const f=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(Xt(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&f.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();bs(t,Ua(t.transactionQueueTree_,e)),Va(t,t.transactionQueueTree_),ut(t.eventQueue_,e,u);for(let h=0;h<f.length;h++)Yn(f[h])}else{if(c==="datastale")for(let f=0;f<n.length;f++)n[f].status===3?n[f].status=4:n[f].status=0;else{De("transaction at "+l.toString()+" failed: "+c);for(let f=0;f<n.length;f++)n[f].status=4,n[f].abortReason=c}ys(t,e)}},o)}function ys(t,e){const n=Ph(t,e),i=Wi(n),r=Oh(t,n);return d1(t,r,i),i}function d1(t,e,n){if(e.length===0)return;const i=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Pe(n,l.path);let u=!1,f;if(E(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,f=l.abortReason,r=r.concat(Xt(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=n1)u=!0,f="maxretry",r=r.concat(Xt(t.serverSyncTree_,l.currentWriteId,!0));else{const h=Nh(t,l.path,o);l.currentInputSnapshot=h;const m=e[a].update(h.val());if(m!==void 0){$a("transaction failed: Data returned ",m,l.path);let y=ye(m);typeof m=="object"&&m!=null&&Ct(m,".priority")||(y=y.updatePriority(h.getPriority()));const D=l.currentWriteId,I=Wa(t),T=wh(y,h,I);l.currentOutputSnapshotRaw=y,l.currentOutputSnapshotResolved=T,l.currentWriteId=kh(t),o.splice(o.indexOf(D),1),r=r.concat(mh(t.serverSyncTree_,l.path,T,l.currentWriteId,l.applyLocally)),r=r.concat(Xt(t.serverSyncTree_,D,!0))}else u=!0,f="nodata",r=r.concat(Xt(t.serverSyncTree_,l.currentWriteId,!0))}ut(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(f==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(f),!1,null))))}bs(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)Yn(i[a]);Va(t,t.transactionQueueTree_)}function Ph(t,e){let n,i=t.transactionQueueTree_;for(n=V(e);n!==null&&qn(i)===void 0;)i=Ua(i,n),e=te(e),n=V(e);return i}function Oh(t,e){const n=[];return Rh(t,e,n),n.sort((i,r)=>i.order-r.order),n}function Rh(t,e,n){const i=qn(e);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);_s(e,r=>{Rh(t,r,n)})}function bs(t,e){const n=qn(e);if(n){let i=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[i]=n[r],i++);n.length=i,Ch(e,n.length>0?n:void 0)}_s(e,i=>{bs(t,i)})}function Mh(t,e){const n=Wi(Ph(t,e)),i=Ua(t.transactionQueueTree_,e);return Wy(i,r=>{Ys(t,r)}),Ys(t,i),xh(i,r=>{Ys(t,r)}),n}function Ys(t,e){const n=qn(e);if(n){const i=[];let r=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(E(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(E(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(Xt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Ch(e,void 0):n.length=s+1,ut(t.eventQueue_,Wi(e),r);for(let o=0;o<i.length;o++)Yn(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _1{constructor(e,n,i,r){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=r}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+de(this.snapshot.exportVal())}}class v1{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b1="FIREBASE_DATABASE_EMULATOR_HOST",Oo={};let w1=!1;function C1(t,e,n,i){t.repoInfo_=new Rf(`${e}:${n}`,!1,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0),i&&(t.authTokenProvider_=i)}function E1(t,e,n,i,r){let s=i||t.options.databaseURL;s===void 0&&(t.options.projectId||_t("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),xe("Using default host for project ",t.options.projectId),s=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=Mc(s,r),a=o.repoInfo,l,c;typeof process<"u"&&process.env&&(c=process.env[b1]),c?(l=!0,s=`http://${c}?ns=${a.namespace}`,o=Mc(s,r),a=o.repoInfo):l=!o.repoInfo.secure;const u=r&&l?new An(An.OWNER):new H_(t.name,t.options,e);Xy("Invalid Firebase Database URL",o),W(o.path)||_t("Database URL must point to the root of a Firebase Database (not including a child path).");const f=I1(a,t,u,new F_(t.name,n));return new S1(f,t)}function x1(t,e){const n=Oo[e];(!n||n[t.key]!==t)&&_t(`Database ${e}(${t.repoInfo_}) has already been deleted.`),u1(t),delete n[t.key]}function I1(t,e,n,i){let r=Oo[e.name];r||(r={},Oo[e.name]=r);let s=r[t.toURLString()];return s&&_t("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new i1(t,w1,n,i),r[t.toURLString()]=s,s}class S1{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(r1(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Et(this._repo,q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(x1(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&_t("Cannot call "+e+" on a deleted database.")}}function Lh(t=u_(),e){const n=o_(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const i=Jm("database");i&&T1(n,...i)}return n}function T1(t,e,n,i={}){t=jn(t),t._checkNotDeleted("useEmulator"),t._instanceStarted&&_t("Cannot call useEmulator() after instance has already been initialized.");const r=t._repoInternal;let s;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&_t('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new An(An.OWNER);else if(i.mockUserToken){const o=typeof i.mockUserToken=="string"?i.mockUserToken:Zm(i.mockUserToken,t.app.options.projectId);s=new An(o)}C1(r,e,n,s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A1(t){C_(c_),Pr(new wi("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return E1(i,r,s,n)},"PUBLIC").setMultipleInstances(!0)),Sn(nc,ic,t),Sn(nc,ic,"esm2017")}gt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};gt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};A1();const Fh={apiKey:"AIzaSyAafPKtLoc5BfiqN-j9AGJLlkIcEbJE3rw",authDomain:"squash-list.firebaseapp.com",databaseURL:"https://squash-list-default-rtdb.firebaseio.com",projectId:"squash-list",storageBucket:"squash-list.appspot.com",messagingSenderId:"537914321064",appId:"1:537914321064:web:6df5523c5fc9d1c9b83a9d"},k1={class:"header"},N1=z("div",{class:"skip"},[z("a",{class:"sr-only sr-only-focusable",href:"#main"}," Skip to content ")],-1),P1=z("div",{class:"logo-wrapper"},[z("img",{src:$m,class:"logo",alt:"Squashlist logo",width:"172",height:"24"})],-1),O1={class:"suggest"},R1=z("span",{class:"tooltip"},"Suggest item",-1),M1={key:0,class:"form-title"},D1=z("span",null,"Suggest item",-1),L1=z("span",{class:"sr-only"},"Close",-1),F1={key:1,class:"error"},H1=z("div",null,"Unable to submit",-1),B1={key:2,class:"success"},z1=z("div",null,"Thanks for making a suggestion!",-1),U1=z("p",null,"Suggest an item to be included in the Squash List",-1),$1=["onSubmit"],W1=z("span",null,[Rn("Name "),z("span",{class:"required"},"*")],-1),j1=z("span",null,[Rn("URL "),z("span",{class:"required"},"*")],-1),V1=z("span",null,"Description",-1),Y1=["disabled"],q1=z("h1",{class:"sr-only"},"Squash sites, apps, & resources",-1),K1={__name:"Header",setup(t){const e=Ye(null),n=Ye(!1),i=Ye({name:"",url:"",desc:""}),r=Ye(null),s=Ye(!0),o=Ye(!1),a=Ye(!1),l=()=>{n.value=!0,i.value={name:"",url:"",desc:""},s.value=!0,o.value=!1,a.value=!1};In(n,h=>{h&&Ou(()=>r.value.focus())}),In(i,h=>{h.name&&h.url?s.value=!1:s.value=!0},{deep:!0});const c=va(Fh),u=Lh(c),f=()=>{s.value=!0,Dh(Po(u,`/suggest/item-${Math.floor(Date.now()*Math.random())}`),ra(i)).then(()=>a.value=!0).catch(()=>o.value=!0)};return ss(()=>{let h=0,m=0;const y=()=>{m>h+100&&(n.value=!1)};e.value.addEventListener("touchstart",w=>{h=w.changedTouches[0].screenX}),e.value.addEventListener("touchend",w=>{m=w.changedTouches[0].screenX,y()}),document.addEventListener("keydown",w=>{w.code==="Escape"&&(n.value=!1)})}),(h,m)=>{const y=aa("font-awesome-icon");return he(),ke("header",k1,[N1,P1,z("div",O1,[z("button",{onClick:l},[R1,ue(y,{icon:"fa-solid fa-circle-plus",class:"icon"})]),z("div",null,[n.value?(he(),ke("div",{key:0,class:"form-bg",onClick:m[0]||(m[0]=w=>n.value=!1)})):ai("",!0),z("div",{class:es(["form",{open:n.value}]),ref_key:"formWrapper",ref:e},[n.value?(he(),ke("h2",M1,[D1,z("button",{class:"close-icon",onClick:m[1]||(m[1]=w=>n.value=!1)},[ue(y,{icon:"fa-solid fa-xmark"}),L1])])):ai("",!0),o.value?(he(),ke("div",F1,[ue(y,{icon:"fa-solid fa-face-frown",class:"icon"}),H1])):a.value?(he(),ke("div",B1,[ue(y,{icon:"fa-solid fa-face-smile",class:"icon"}),z1])):(he(),ke(Ne,{key:3},[n.value?(he(),ke(Ne,{key:0},[U1,z("form",{onSubmit:Lm(f,["prevent"])},[z("label",null,[W1,Ns(z("input",{"onUpdate:modelValue":m[2]||(m[2]=w=>i.value.name=w),type:"text",name:"name",required:"",ref_key:"nameInput",ref:r},null,512),[[Ds,i.value.name]])]),z("label",null,[j1,Ns(z("input",{"onUpdate:modelValue":m[3]||(m[3]=w=>i.value.url=w),type:"text",name:"url",required:""},null,512),[[Ds,i.value.url]])]),z("label",null,[V1,Ns(z("input",{"onUpdate:modelValue":m[4]||(m[4]=w=>i.value.desc=w),type:"text",name:"desc"},null,512),[[Ds,i.value.desc]])]),z("button",{type:"submit",disabled:s.value}," Submit ",8,Y1)],40,$1)],64)):ai("",!0)],64))],2)])]),q1])}}},Hh=(t,e)=>{const n=t.__vccOpts||t;for(const[i,r]of e)n[i]=r;return n},G1={},Q1={class:"footer"},X1=z("img",{src:"//nuxmo.github.io/media/img/m11t.jpg",alt:"m11t"},null,-1),J1=z("a",{href:"/"},"Nuxmo",-1);function Z1(t,e){return he(),ke("footer",Q1,[X1,Rn(" a "),J1,Rn(" project ")])}const eb=Hh(G1,[["render",Z1]]);const tb=["href"],nb={class:"desc"},ib={__name:"Item",props:{item:Object},setup(t){Om(i=>({bda018a2:n.degrees,ef45bcbe:n.position}));const e=Math.random()<.5?"-":"",n={degrees:`${e}${Math.random()/1.5}deg`,position:`${e}${Math.random()*3}px`};return(i,r)=>{const s=aa("font-awesome-icon");return he(),ke("a",{href:t.item.url,class:"item"},[z("p",null,[Rn(Er(t.item.name)+" ",1),t.item.paid?(he(),as(s,{key:0,icon:"fa-solid fa-money-bills",class:"money-icon",title:"Paid service"})):ai("",!0)]),z("p",nb,Er(t.item.desc),1)],8,tb)}}},rb=Hh(ib,[["__scopeId","data-v-99d85e0c"]]),sb={class:"category"},ob={class:"items-wrapper"},ab={__name:"Category",props:{category:Object},setup(t){const e=t,n=Ye(!0),i=Be(()=>e.category.items.sort((r,s)=>n.value?r.name>s.name?1:-1:r.name<s.name?1:-1));return(r,s)=>{const o=aa("font-awesome-icon");return he(),ke("div",sb,[z("h2",null,[ue(o,{icon:`fa-solid fa-${t.category.icon}`,class:"icon"},null,8,["icon"]),z("span",null,Er(t.category.cat),1),z("button",{onClick:s[0]||(s[0]=a=>n.value=!n.value)},[ue(o,{icon:`fa-solid ${n.value?"fa-arrow-down-a-z":"fa-arrow-up-z-a"}`,title:n.value?"Sort Z to A":"Sort A to Z",class:"icon"},null,8,["icon","title"])])]),z("div",ob,[(he(!0),ke(Ne,null,$u(i.value,a=>(he(),as(rb,{item:a},null,8,["item"]))),256))])])}}};const lb={class:"wrapper"},cb={class:"container",id:"main"},ub={key:0,class:"loading"},fb=z("img",{src:Um,alt:"loading icon",width:"40"},null,-1),hb=z("span",{class:"sr-only"},"Loading lists...",-1),db=[fb,hb],pb={key:1,class:"error"},mb="*K^3j3YCB80cjijCxNg9JC2AlWyXBZh*zlcbaAilqL2YGx8q9CHcj5dJ$UgFcGooPV*lD5kpkOQswP4zcH$7GB6&ZifR009NFid",gb={__name:"App",setup(t){const e=va(Fh),n=Lh(e),i=Po(n),r=Ye([]),s=Ye(""),o=Ye(0);ss(()=>{a(),!({}.VITE_DEV||document.location.search.includes("no-stats"))&&l()});const a=()=>{Dc(Pi(i,"categories")).then(u=>{u.exists()?r.value=u.val().data:console.log("No data available")}).catch(u=>{s.value=u})},l=()=>{Dc(Pi(i,"visits")).then(u=>{u.exists()?(o.value=u.val().data,o.value++,c()):console.log("No data available")}).catch(u=>{console.log(u)})},c=()=>{Dh(Po(n,"/visits/"),{data:ra(o),token:mb})};return(u,f)=>(he(),ke(Ne,null,[ue(K1),z("div",lb,[z("main",cb,[r.value.length?ai("",!0):(he(),ke("div",ub,db)),s.value?(he(),ke("div",pb,Er(s.value),1)):(he(!0),ke(Ne,{key:2},$u(r.value,h=>(he(),as(ab,{category:h},null,8,["category"]))),256))])]),ue(eb)],64))}};function Lc(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(t);e&&(i=i.filter(function(r){return Object.getOwnPropertyDescriptor(t,r).enumerable})),n.push.apply(n,i)}return n}function k(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Lc(Object(n),!0).forEach(function(i){ge(t,i,n[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Lc(Object(n)).forEach(function(i){Object.defineProperty(t,i,Object.getOwnPropertyDescriptor(n,i))})}return t}function jr(t){return jr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},jr(t)}function _b(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function Fc(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function vb(t,e,n){return e&&Fc(t.prototype,e),n&&Fc(t,n),Object.defineProperty(t,"prototype",{writable:!1}),t}function ge(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function Ka(t,e){return bb(t)||Cb(t,e)||Bh(t,e)||xb()}function ji(t){return yb(t)||wb(t)||Bh(t)||Eb()}function yb(t){if(Array.isArray(t))return Ro(t)}function bb(t){if(Array.isArray(t))return t}function wb(t){if(typeof Symbol<"u"&&t[Symbol.iterator]!=null||t["@@iterator"]!=null)return Array.from(t)}function Cb(t,e){var n=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(n!=null){var i=[],r=!0,s=!1,o,a;try{for(n=n.call(t);!(r=(o=n.next()).done)&&(i.push(o.value),!(e&&i.length===e));r=!0);}catch(l){s=!0,a=l}finally{try{!r&&n.return!=null&&n.return()}finally{if(s)throw a}}return i}}function Bh(t,e){if(!!t){if(typeof t=="string")return Ro(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);if(n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set")return Array.from(t);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return Ro(t,e)}}function Ro(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,i=new Array(e);n<e;n++)i[n]=t[n];return i}function Eb(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
